                            ...
                            <div class="card-body p-9 pt-5">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="d-flex flex-column justify-content-center flex-row-fluid pe-11 mb-5">
                                        @php
                                          $ran = array('bg-success','bg-danger','bg-gray-300','bg-primary');                                            
                                        @endphp
                                        <!--begin::Label-->
                                ...
                                <div class="d-flex flex-column mb-9">
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_610d48158eca4">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <!--begin::Menu 1-->
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_610d48158f22b">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                                <div class="fs-5 text-dark fw-bolder">Filter Options</div>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <!--begin::Menu 1-->
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_610d48158f6d2">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                                <div class="fs-5 text-dark fw-bolder">Filter Options</div>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Menu 1-->
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_610d48158fb7c">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                                <div class="fs-5 text-dark fw-bolder">Filter Options</div>
                                            </div>
                        ...
                        <div class="card card-flush h-lg-100">
                            ...
                            <div class="card-body d-flex flex-column mb-9 p-9 pt-3">
                                ...
                                <div class="d-flex align-items-center position-relative mb-7">
                                    ...
                                    <div class="fw-bold">
                                        <a href="#"
                                            class="fs-6 fw-bolder text-gray-900 text-hover-primary">Schedule a meeting
                                ...
                                <div class="d-flex align-items-center position-relative mb-7">
                                    ...
                                    <div class="fw-bold">
                                        <a href="#"
                                            class="fs-6 fw-bolder text-gray-900 text-hover-primary">Dashgboard UI &amp; UX
                                            for Leafr CRM</a>
                                        <!--begin::Info-->
                                        <div class="text-gray-400">Due in 1 week
